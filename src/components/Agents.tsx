...
const Agents = ({
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full h-full px-4 bg-white sm:px-16 py-2 mb-4'>
            <Swiper
                    ...
                    <SwiperSlide key={index}>
                        <div className="grid-slider grid grid-cols-3 gap-4">
                            {agentsChunk.map((agent) => (
                                <div
                                    key={agent.id}
                                    className="flex flex-col lg:flex-row-reverse justify-between rounded-xl border-2 border-[#333333] py-2 px-2"
                                >
                                    <div className="relative flex flex-col justify-center items-center gap-1">
                                        ...
                                        />
                                        <p className="text-[#333333] text-[14px]">{agent.name}</p>
                                        <div className="bg-[#333333] rounded-2xl text-[12px] text-white py-1 px-2">
                                            {agent.jobTitle}
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col justify-between py-2 gap-2 lg:w-2/3">
                                        <div className="flex flex-row-reverse justify-between w-full gap-2 text-[#333333] text-[12px]">
                                            ...
                                            <div className="flex flex-row-reverse gap-1">
                                                <p className="text-[12px] md:text-[16px] font-medium">{agent.sales}+</p>
                                        ...
                                        <div className="flex flex-row-reverse justify-between text-[#333333] text-[12px]">
                                            ...
                                            <div className="flex flex-row-reverse gap-1">
                                                <p className="text-[12px] md:text-[16px] font-medium">{agent.aria}</p>
